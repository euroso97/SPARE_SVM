...
from svmtrainer import SVMModel #, load_tabular_data # Uncomment if you use it
...
def run_example():
    ...
    #     features_df_loaded, labels_series_loaded = load_tabular_data(csv_path, 'target')
    #     X_train_csv, X_test_csv, y_train_csv, y_test_csv = train_test_split(
    #         features_df_loaded, labels_series_loaded, test_size=0.2, random_state=42, stratify=labels_series_loaded
    #     )
